    ...
    <div className="productdetails-container">
      ...
      <div className="productdetails-box">
        ...
        <div className="productdetails-gallery">
          ...
          >
            <img src={mainImage} alt={product.name} className="carousel-img" />
          </div>

          <div
            className={`thumbnail-row ${
              window.innerWidth <= 768 ? "swipeable" : ""
            }`}
          >
          ...
          {product.stock > 0 && (
            <>
              ...
              <div className="pd-option">
                ...
                >
                  Need help with sizing? <span>View Size Guide</span>
                </p>
              </div>
          ...
          <div className="pd-actions">
            ...
            <button
              className={`pd-btn wishlist ${
                wishlist.some((p) => p.id === product.id) ? "active" : ""
              }`}
